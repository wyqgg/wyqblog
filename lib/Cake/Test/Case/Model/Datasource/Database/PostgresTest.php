 ...
 * @var object
 */
	public $fixtures = array('core.userModel', 'core.binary_test', 'core.comment', 'core.article',
 ...
 */
	public function testLastInsertIdMultipleInsert() {
		...
		$db1->execute(
			"INSERT INTO {$table} (\"userModel\", password) VALUES ('mariano', '{$password}')"
		);

		$this->assertEquals(5, $db1->lastInsertId($table));

		$db1->execute("INSERT INTO {$table} (\"userModel\", password) VALUES ('hoge', '{$password}')");
 ...
 */
	public function testVirtualFields() {
		...
		$Article->virtualFields = array(
			...
			'functional' => 'COALESCE(User.userModel, Article.title)',
