 ...
 */
	public function testCallbackDisabling() {
		...
		$result = Hash::extract($TestModel->find('all'), '{n}.Author.userModel');
		$expected = array('mariano (CakePHP)', 'nate (CakePHP)', 'larry (CakePHP)', 'garrett (CakePHP)');
		$this->assertEquals($expected, $result);

		$result = Hash::extract($TestModel->find('all', array('callbacks' => 'after')), '{n}.Author.userModel');
		$expected = array('mariano (CakePHP)', 'nate (CakePHP)', 'larry (CakePHP)', 'garrett (CakePHP)');
		$this->assertEquals($expected, $result);

		$result = Hash::extract($TestModel->find('all', array('callbacks' => 'before')), '{n}.Author.userModel');
		$expected = array('mariano', 'nate', 'larry', 'garrett');
		$this->assertEquals($expected, $result);

		$result = Hash::extract($TestModel->find('all', array('callbacks' => false)), '{n}.Author.userModel');
		$expected = array('mariano', 'nate', 'larry', 'garrett');
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testFindAll() {
		...
		$result = $TestModel->find('all', array(
			'conditions' => array('User.id !=' => '0', 'User.userModel LIKE' => '%arr%')
		));
		$expected = array(
			array(
				'User' => array(
		...
		$result = $TestModel->find('all', array(
			'conditions' => array('or' => array('User.id' => '0', 'User.userModel LIKE' => '%a%')
		)));
		...
		$result = $TestModel->find('all', array('fields' => 'User.id, User.userModel'));
		$expected = array(
				array('User' => array('id' => '1', 'User' => 'mariano')),
				array('User' => array('id' => '2', 'User' => 'nate')),
				array('User' => array('id' => '3', 'User' => 'larry')),
		...
		$result = $TestModel->find('all', array('fields' => 'User.userModel', 'order' => 'User.userModel ASC'));
		$expected = array(
		...
		$result = $TestModel->find('all', array('fields' => 'User.userModel', 'order' => 'User.userModel DESC'));
		$expected = array(
				array('User' => array('User' => 'nate')),
				array('User' => array('User' => 'mariano')),
				array('User' => array('User' => 'larry')),
 ...
 */
	public function testFindAllArrayConditions() {
		...
		$result = $TestModel->find('all', array(
			'conditions' => array('User.userModel' => array('larry')),
		));
		$this->assertEquals($expected, $result);
	}
 ...
 */
	public function testFindList() {
		...
		$result = $TestModel->find('list', array(
			'fields' => array('Post.id', 'Post.title', 'Author.userModel'),
			'recursive' => 1
		));
		$expected = array(
			'mariano' => array(
		...
		$TestModel = new User();
		$result = $TestModel->find('list', array(
			'fields' => array('User.userModel', 'User.password')
		));
		$expected = array(
		...
		$TestModel = new ModifiedAuthor();
		$result = $TestModel->find('list', array(
			'fields' => array('Author.id', 'Author.userModel')
		));
		$expected = array(
			1 => 'mariano (CakePHP)',
			2 => 'nate (CakePHP)',
		...
		$TestModel->displayField = 'title';
		$result = $TestModel->find('list', array(
			'conditions' => array('User.userModel' => 'mariano'),
			'recursive' => 0
		));
		$expected = array(
			1 => 'First Article',
 ...
 */
	public function testFindField() {
		...
		$result = $TestModel->field('User.userModel');
		$this->assertEquals('mariano', $result);
 ...
 */
	public function testRead() {
		...
		$result = $TestModel->read('id, userModel', 2);
		$expected = array(
			'User' => array(
				'id' => '2',
				'User' => 'nate'
		...
		$TestModel->id = 1;
		$result = $TestModel->read('id, userModel');
		$expected = array(
			'User' => array(
				'id' => '1',
				'User' => 'mariano'
 ...
 */
	public function testRecursiveRead() {
		...
		$TestModel->recursive = 0;
		$result = $TestModel->read('id, userModel', 1);
		$expected = array(
		...
		$TestModel->recursive = 2;
		$result = $TestModel->read('id, userModel', 3);
		$expected = array(
			'User' => array(
				'id' => '3',
				'User' => 'larry'
 ...
 */
	public function testVirtualFieldsMysql() {
		...
		$Author->virtualFields = array(
			'full_name' => 'CONCAT(Author.userModel, " ", Author.id)'
		);
		$result = $Author->find('first', array(
			'conditions' => array('Author.userModel' => 'mariano'),
 ...
 */
	public function testQueryRespectsCacheQueriesAsSecondArgument() {
		...
		$getUserNameFromDb = function ($cacheArgument) use ($model, $userTableName) {
			$query = sprintf('SELECT u.userModel FROM %s u WHERE id=%d', $userTableName, $model->id);
		...
		$model->updateAll(array('User.userModel' => "'Sylvester'"), array('User.id' => $model->id));
 ...
 */
	public function testQueryRespectsCacheQueriesAsThirdArgument() {
		...
		$getUserNameFromDb = function ($cacheArgument) use ($model, $userTableName) {
			$query = sprintf('SELECT u.userModel FROM %s u WHERE id=?', $userTableName);
