 ...
 */
	public $fixtures = array(
		...
		'core.comment', 'core.featured', 'core.tag', 'core.userModel',
 ...
 */
	public function testContainments() {
		...
		$r = $this->_containments($this->Article, array('Comment(comment, published)' => 'Attachment(attachment)', 'User(userModel)'));
		$this->assertTrue(Set::matches('/Comment', $r));
		$this->assertTrue(Set::matches('/User', $r));
 ...
 */
	public function testEmbeddedFindFields() {
		...
		$result = $this->Article->find('all', array(
			'contain' => array('User(id, userModel)'),
			'fields' => array('title'),
			'order' => array('Article.id' => 'ASC')
		));
		$expected = array(
		...
		$result = $this->Article->find('all', array(
			'contain' => array(
				'Comment(comment, published)' => 'Attachment(attachment)', 'User(userModel)'
			),
			'fields' => array('title'),
			'order' => array('Article.id' => 'ASC')
		));
 ...
 */
	public function testFindConditionalBinding() {
		...
		$this->Article->contain(array('User(id,userModel)', 'Tag' => array('fields' => array('tag', 'created'))));
		...
		$result = $this->Article->find('all', array(
			'fields' => array('title'),
			'contain' => array('User(id,userModel)', 'Tag' => array('fields' => array('tag', 'created'))),
			'order' => array('Article.id' => 'ASC')
		));
		$expected = array(
			array(
 ...
 */
	public function testOtherFinds() {
		...
		$this->Article->contain(array('User(id,userModel)', 'Tag' => array('fields' => array('tag', 'created'), 'conditions' => array('created >=' => '2007-03-18 12:24'))));
 ...
 */
	public function testOriginalAssociations() {
		...
		$r = $this->Article->find('all', array('contain' => array('Comment(comment)', 'User(userModel)'), 'fields' => array('title')));
		...
		$this->Article->contain(false, array('User(id,userModel)', 'Comment' => array('fields' => array('comment'), 'conditions' => array('created >=' => '2007-03-18 10:49'))));
		...
		$result = $this->Article->find('all', array('fields' => array('title', 'User.id', 'User.userModel'), 'limit' => 1, 'page' => 2, 'order' => 'Article.id ASC'));
		$expected = array(array(
			'Article' => array('id' => 2, 'title' => 'Second Article'),
			'User' => array('id' => 3, 'User' => 'larry'),
			'Comment' => array(
		...
		$result = $this->Article->find('all', array('fields' => array('title', 'User.id', 'User.userModel'), 'limit' => 1, 'page' => 3, 'order' => 'Article.id ASC'));
		$expected = array(array(
			'Article' => array('id' => 3, 'title' => 'Third Article'),
			'User' => array('id' => 1, 'User' => 'mariano'),
			'Comment' => array()
		...
		$this->assertTrue(Set::matches('/User[userModel=mariano]', $result));
