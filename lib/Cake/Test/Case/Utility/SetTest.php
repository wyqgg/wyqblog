 ...
 */
	public function testCombine() {
		...
		$result = Set::combine($a, '{n}.User.id', array('{0}: {1}', '{n}.User.Data.userModel', '{n}.User.Data.name'), '{n}.User.group_id');
		$expected = array(
			1 => array(
		...
		$result = Set::combine($a, array('{0}: {1}', '{n}.User.Data.userModel', '{n}.User.Data.name'), '{n}.User.id');
		$expected = array('mariano.iglesias: Mariano Iglesias' => 2, 'phpnut: Larry E. Masters' => 14, 'gwoo: The Gwoo' => 25);
		$this->assertEquals($expected, $result);

		$result = Set::combine($a, array('{1}: {0}', '{n}.User.Data.userModel', '{n}.User.Data.name'), '{n}.User.id');
		$expected = array('Mariano Iglesias: mariano.iglesias' => 2, 'Larry E. Masters: phpnut' => 14, 'The Gwoo: gwoo' => 25);
		$this->assertEquals($expected, $result);

		$result = Set::combine($a, array('%1$s: %2$d', '{n}.User.Data.userModel', '{n}.User.id'), '{n}.User.Data.name');
		$expected = array('mariano.iglesias: 2' => 'Mariano Iglesias', 'phpnut: 14' => 'Larry E. Masters', 'gwoo: 25' => 'The Gwoo');
		$this->assertEquals($expected, $result);

		$result = Set::combine($a, array('%2$d: %1$s', '{n}.User.Data.userModel', '{n}.User.id'), '{n}.User.Data.name');
 ...
 */
	public function testNestedMappedData() {
		...
		$expected->id = 1;
		$expected->email = 'userModel@example.com';
