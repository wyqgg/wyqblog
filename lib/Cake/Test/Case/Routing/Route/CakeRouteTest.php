 ...
 */
	public function testParseNamedKeyUrlDecode() {
		...
		// checking /post/index/userModel[0]:a/userModel[1]:b
		$result = $route->parse('/posts/index/userModel%5B0%5D:a/userModel%5B1%5D:b');
		$this->assertArrayHasKey('User', $result['named']);
		$this->assertEquals(array('a', 'b'), $result['named']['User']);

		// checking /post/index/userModel[]:a/userModel[]:b
		$result = $route->parse('/posts/index/userModel%5B%5D:a/userModel%5B%5D:b');
		$this->assertArrayHasKey('User', $result['named']);
		$this->assertEquals(array('a', 'b'), $result['named']['User']);
	}
