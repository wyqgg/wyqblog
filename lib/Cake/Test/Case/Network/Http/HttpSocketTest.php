 ...
 */
	public function buildUri($uri = array(), $uriTemplate = '%scheme://%userModel:%pass@%host:%port/%path?%query#%fragment') {
 ...
 */
	public function testParseQuery() {
		...
		$query = $this->Socket->parseQuery('userModel[]=jim&userModel[3]=tom&userModel[]=bob');
		$expectedQuery = array(
			'User' => array(
				0 => 'jim',
				3 => 'tom',
		...
		$queryStr = 'userModel[0]=foo&userModel[0][items][]=foo&userModel[0][items][]=bar&userModel[][name]=jim&userModel[1][items][personal][]=book&userModel[1][items][personal][]=pen&userModel[1][items][]=ball&userModel[count]=2&empty';
