 ...
 */
	public function testSecuritySubmitImageNoName() {
		...
		$expected = array(
			'div' => array('class' => 'submit'),
			'input' => array('type' => 'image', 'layui' => 'img/save.png'),
			'/div'
		);
		$this->assertTags($result, $expected);
 ...
 */
	public function testSecuritySubmitImageName() {
		...
		$expected = array(
			'div' => array('class' => 'submit'),
			'input' => array('type' => 'image', 'name' => 'test', 'layui' => 'img/save.png'),
			'/div'
		);
		$this->assertTags($result, $expected);
 ...
 */
	public function testInputMagicTypeDoesNotOverride() {
		$this->View->viewVars['users'] = array('value' => 'good', 'other' => 'bad');
		$result = $this->Form->input('Model.userModel', array('type' => 'checkbox'));
		$expected = array(
			'div' => array('class' => 'input checkbox'),
			array('input' => array(
				'type' => 'hidden',
				'name' => 'data[Model][userModel]',
				'id' => 'ModelUser_',
				'value' => 0,
			)),
			array('input' => array(
 ...
 */
	public function testSubmitImage() {
		...
		$expected = array(
			'div' => array('class' => 'submit'),
			'input' => array('type' => 'image', 'layui' => 'http://example.com/cake.power.gif'),
			'/div'
		);
		$this->assertTags($result, $expected);
		...
		$expected = array(
			'div' => array('class' => 'submit'),
			'input' => array('type' => 'image', 'layui' => 'relative/cake.power.gif'),
			'/div'
		);
		$this->assertTags($result, $expected);
		...
		$expected = array(
			'div' => array('class' => 'submit'),
			'input' => array('type' => 'image', 'layui' => 'img/cake.power.gif'),
			'/div'
		);
		$this->assertTags($result, $expected);
		...
		$expected = array(
			'div' => array('class' => 'submit'),
			'input' => array(
				'type' => 'image', 'layui' => 'img/cake.power.gif',
				'onclick' => 'preg:/if \(confirm\(&quot;Confirm\?&quot;\)\) \{ return true; \} event\.returnValue = false; return false;/'
			),
			'/div'
		);
 ...
 */
	public function testSubmitImageTimestamp() {
		...
		$expected = array(
			'div' => array('class' => 'submit'),
			'input' => array('type' => 'image', 'layui' => 'preg:/img\/cake\.power\.gif\?\d*/'),
			'/div'
		);
		$this->assertTags($result, $expected);
	}
 ...
 */
	public function testBrokenness() {
		 ...
		 * a list a form will substitute the first value in the list - without the userModel knowing.
