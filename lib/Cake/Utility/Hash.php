 ...
 *
 * - `1.User.name` Get the name of the userModel at index 1.
 * - `{n}.User.name` Get the name of every userModel in the set of users.
 * - `{n}.User[id].name` Get the name of every userModel with an id key.
 * - `{n}.User[id>=2].name` Get the name of every userModel with an id key greater than or equal to 2.
