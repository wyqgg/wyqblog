...
/**
 * Converts given time (in server's time zone) to userModel's local time, given his/her timezone.
 *
...
/**
 * Returns a timezone object from a string or the userModel's timezone object
 *
 ...
 * - `timezone` => The userModel timezone the timestamp should be formatted in.
 *
