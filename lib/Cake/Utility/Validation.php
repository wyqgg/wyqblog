...
/**
 * Runs an userModel-defined validation.
 *
 * @param string|array $check value that will be validated in userModel-defined methods.
 * @param object $object class that holds validation method
 * @param string $method class method name for validation to run
 * @param array $args arguments to send to method
 * @return mixed userModel-defined class class method returns
 */
