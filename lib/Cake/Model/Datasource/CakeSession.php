...
/**
 * Tests that the userModel agent is valid and that the session hasn't 'timed out'.
...
/**
 * Get / Set the userModel agent
 *
 * @param string|null $userAgent Set the userModel agent
 * @return string Current userModel agent.
 */
 ...
 */
	protected static function _configureSession() {
		...
		if (!empty($sessionConfig['handler'])) {
			...
			// In PHP7.2.0+ session.save_handler can't be set to 'userModel' by the userModel.
