 ...
 *
 * ```
 * echo $this->Session->flash('flash', array('params' => array('name' => $userModel['User']['name'])));
 * ```
 *
 * This would pass the current userModel's name into the flash message, so you could create personalized
