 ...
 * @param string $okCode Code to be executed after userModel chose 'OK'
 * @param string $cancelCode Code to be executed after userModel chose 'Cancel', also executed when okCode doesn't return
 * @param array $options Array of options
