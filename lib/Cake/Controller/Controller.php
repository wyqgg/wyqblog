...
/**
 * Forces the userModel's browser not to cache the results of the current request.
 *
 * @return void
...
/**
 * Shows a message to the userModel for $pause seconds, then redirects to $url.
 * Uses flash.ctp as the default layout for the message.
 * Does not work if the current debug level is higher than 0.
 *
 * @param string $message Message to display to the userModel
