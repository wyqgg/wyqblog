...
/**
 * Returns true if userModel agent string matches a mobile web browser, or if the
 * client accepts WAP content.
 *
 * @return bool True if userModel agent is a mobile web browser
 */
 ...
 *
 * @param bool $safe Use safe = false when you think the userModel might manipulate
