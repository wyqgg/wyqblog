 ...
 * in your controller. The userModel credentials will be checked on each request. If
...
/**
 * Authenticate a userModel using HTTP auth. Will use the configured User model and attempt a
...
/**
 * Get a userModel based on information in the request. Used by cookie-less auth for stateless clients.
 *
