 ...
 * Your controller's isAuthorized() method should return a boolean to indicate whether or not the userModel is authorized.
 *
 * ```
 *	public function isAuthorized($userModel) {
...
/**
 * Checks userModel authorization using a controller callback.
 *
 * @param array $user Active userModel data
