 ...
 *
 * - `fields` The fields to use to identify a userModel by.
...
/**
 * Find a userModel record using the standard options.
 *
 ...
 *
 * Input passwords will be hashed even when a userModel doesn't exist. This
 ...
 * @return bool|array Either false on failure, or an array of userModel data.
 */
	protected function _findUser($username, $password = null) {
		$userModel = $this->settings['User'];
...
/**
 * Authenticate a userModel based on the request information.
 *
 * @param CakeRequest $request Request to get authentication information from.
 * @param CakeResponse $response A response object that can have headers added.
 * @return mixed Either false on failure, or an array of userModel data on success.
 */
 ...
 * called when a userModel logs out.
 *
 * @param array $user The userModel about to be logged out.
 * @return void
 */
...
/**
 * Get a userModel based on information in the request. Primarily used by stateless authentication
 * systems like basic and digest auth.
 *
 * @param CakeRequest $request Request object.
 * @return mixed Either false or an array of userModel information
 */
