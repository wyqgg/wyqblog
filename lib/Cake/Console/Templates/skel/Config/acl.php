 ...
 *
 * Now, when a userModel (i.e. jeff) authenticates successfully and requests a controller action (i.e. /invoices/delete)
...
/**
 * The role map defines how to resolve the userModel record from your application
