...
/**
 * Confirm a to be baked controller with the userModel
 *
...
/**
 * Interact with the userModel and ask about which methods (admin or regular they want to bake)
 *
...
/**
 * Interact with the userModel and get a list of additional helpers
 *
 * @return array Helpers that the userModel wants to use.
 */
...
/**
 * Interact with the userModel and get a list of additional components
 *
 * @return array Components the userModel wants to use.
 */
...
/**
 * Forces the userModel to specify the controller he wants to bake, and returns the selected controller name.
 *
