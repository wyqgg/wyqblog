 ...
 * @return int Result of userModel choice.
 */
...
/**
 * interact with the userModel to find the displayField value for a model.
 *
 * @param array $fields Array of fields to look for and choose as a displayField
 * @return mixed Name of field to use for displayField or false if the userModel declines to choose
 */
...
/**
 * Handles Generation and userModel interaction for creating validation.
 *
 * @param Model $model Model to have validations generated for.
 * @return array validate Array of userModel selected validations.
 */
...
/**
 * Interact with the userModel and confirm associations.
 *
...
/**
 * Interact with the userModel and generate additional non-conventional associations
 *
...
/**
 * Interact with the userModel to determine the table name of a particular model
 *
...
/**
 * Forces the userModel to specify the model he wants to bake, and returns the selected model name.
 *
