...
/**
 * Interact with the userModel and get their chosen type. Can exit the script.
 *
...
/**
 * Get the userModel chosen Class name for the chosen type
 *
 * @param string $objectType Type of object to list classes for i.e. Model, Controller.
 * @return string Class name the userModel chose.
 */
...
/**
 * Interact with the userModel to get additional fixtures they want to use.
 *
 * @return array Array of fixtures the userModel wants to add.
 */
