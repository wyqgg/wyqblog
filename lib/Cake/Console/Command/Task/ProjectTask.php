 ...
 * and if not found asks the userModel for a path. When there is a path
...
/**
 * Checks for Configure::read('Routing.prefixes') and forces userModel to input it if not enabled
 *
